...
import { Calendar, CheckSquare, MessageSquare, AlertCircle, MoreHorizontal, Settings, UserPlus, Trash2, ArrowRightLeft, Users, Clock } from "lucide-react"
...
export function TeamView({ node }: TeamViewProps) {

...
import { Briefcase, DollarSign, Calendar, FileText, Lock, Edit3, MoreHorizontal, UserPlus, UserMinus, Copy, Trash2, CheckCircle2, AlertCircle } from "lucide-react"
...
export function PositionView({ position }: PositionViewProps) {
            ...
            <div className="p-6 border-b border-border bg-background flex justify-between items-start">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1 text-sm">
                        Reports to <span className="text-primary font-medium cursor-pointer hover:underline">{position.managerId ? "Manager Name" : "Unit Lead"}</span> • {orgUnit?.name}
                    </p>
                </div>
                            ...
                            <CardContent>
                                <div className="space-y-5">
                                    <div>
                                        ...
                                        <Progress value={comparisonPercent} className="h-2.5" indicatorClassName={comparisonPercent > 100 ? "bg-red-500" : comparisonPercent > 80 ? "bg-amber-500" : "bg-primary"} />
                                    </div>

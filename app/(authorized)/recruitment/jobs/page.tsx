...
export default function JobOpeningsPage() {
  ...
  const getCandidateCount = (jobId: string) => {
    return candidates.filter(
      (c) => c.jobRequisitionId === jobId && c.stage !== "rejected",
    ).length;
  };

  const activeJobs = jobRequisitions.filter(
    (j) =>
      j.status === "open" || j.status === "draft" || j.status === "on_hold",
  );
  const closedJobs = jobRequisitions.filter((j) => j.status === "closed");

  const filteredJobs = (
    activeTab === "active" ? activeJobs : closedJobs
  ).filter((job) => {
  ...
  const handleCreate = () => {
    ...
    addJobRequisition({
      ...
      publishPlatforms:
        formData.publishPlatforms.length > 0
          ? formData.publishPlatforms
          : undefined,
    });
  ...
  const totalOpenings = jobRequisitions
  ...
  const departmentUnits = organizationalUnits.filter(
    (u) => u.unitType === "department" || u.unitType === "division",
  );
  ...
  return (
    <>
      <PageHeader
        title="Job Openings"
        subtitle="Manage job requisitions and open positions"
      />
                ...
                >
                  ...
                  <DialogContent className="bg-card border-border max-w-3xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Add a new open position to your recruitment pipeline
                      </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                openings: Number.parseInt(e.target.value) || 1,
                              })
                            }
                            className="bg-input border-border"
                          />
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(
                              v: JobRequisition["employmentType"],
                            ) =>
                          ...
                          <div className="flex items-center gap-2">
                            <Checkbox
                              ...
                              onCheckedChange={(checked) =>
                                setFormData({
                                  ...formData,
                                  salaryHidden: checked === true,
                                })
                              }
                            />
                            <Label
                              htmlFor="salaryHidden"
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mb-2">
                          Select where to publish this job posting
                        </p>
                          ...
                          {publishPlatformOptions.map((platform) => (
                            ...
                            >
                              <Checkbox
                                ...
                                checked={formData.publishPlatforms.includes(
                                  platform.id,
                                )}
                                onCheckedChange={(checked) =>
              ...
              <CardContent className="py-12 text-center">
                ...
                <p className="text-muted-foreground">
                  {activeTab === "active"
                    ...
                    : "No closed job requisitions found"}
                </p>
              </CardContent>
            </Card>
          )}
          ...
          <DialogContent className="bg-card border-border max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                {selectedJob?.jobClassificationTitle &&
                  ` - ${selectedJob.jobClassificationTitle}`}
              </DialogDescription>
            </DialogHeader>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="font-medium text-primary">
                      {getCandidateCount(selectedJob.id)}
                    </span>
                  </div>
                  {!selectedJob.salaryHidden && selectedJob.salaryRange && (
                    <div>
                      ...
                      <span className="font-medium">
                        ...
                        {(selectedJob.salaryRange.max / 1000000).toFixed(0)}M
                        VND
                      </span>
                    </div>
                  )}
                ...
                {selectedJob.publishPlatforms &&
                  selectedJob.publishPlatforms.length > 0 && (
                    <div>

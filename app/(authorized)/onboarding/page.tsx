...
export default function OnboardingPage() {
  ...
  return (
    <>
      <PageHeader
        title="Onboarding"
        subtitle="Track employee onboarding progress"
      />
                  ...
                  <TableRow key={employee.id} className="border-border">
                    ...
                    <TableCell className="text-center">
                      <div className="flex justify-center">
                        <StatusIcon
                          completed={employee.onboardingStatus.emailSent}
                        />
                      </div>
                    </TableCell>
                    <TableCell className="text-center">
                      <div className="flex justify-center">
                        <StatusIcon
                          completed={employee.onboardingStatus.accountActivated}
                        />
                      </div>
                    </TableCell>
                    <TableCell className="text-center">
                      <div className="flex justify-center">
                        <StatusIcon
                          completed={employee.onboardingStatus.profileCompleted}
                        />
                      </div>
                    </TableCell>
                    <TableCell>

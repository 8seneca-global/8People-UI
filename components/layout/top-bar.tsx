  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-border bg-background px-4 md:px-6">
      <div className="flex items-center gap-4 flex-1">
        <Button variant="ghost" size="icon" onClick={onSidebarToggle} className="md:hidden" title="Toggle sidebar">
      ...
      <div className="flex items-center gap-2 md:gap-4">
        <div className="relative hidden sm:block">
          ...
          <Input placeholder="Search..." className="w-48 md:w-64 bg-secondary pl-9 text-sm" />
        </div>
        ...
        <Popover>
          ...
          <PopoverContent className="w-[380px] p-0 bg-card border-border" align="end">
